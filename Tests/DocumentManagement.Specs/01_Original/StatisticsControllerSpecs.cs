...
namespace DocumentManagement.Specs._01_Original
{
    public class StatisticsControllerSpecs
    {
        ...
        public async Task When_a_StateTransitionedEvent_is_applied_to_a_DocumentCountProjection_the_controller_should_return_1()
        {
            ...
            using (var inMemoryRavenTestDriver = new InMemoryRavenDatabase())
            using (IDocumentStore ravenDbDocumentStore = inMemoryRavenTestDriver.GetDocumentStore())
            {
        ...
        private class InMemoryRavenDatabase : RavenTestDriver
        {
