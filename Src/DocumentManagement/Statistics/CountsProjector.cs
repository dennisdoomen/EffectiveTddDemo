...
namespace DocumentManagement.Statistics
{
    public class CountsProjector
    {
        ...
        private readonly GetRavenSession geRavenSession;
        ...
        public CountsProjector(Dispatcher dispatcher, GetRavenSession geRavenSession)
        {
            this.dispatcher = dispatcher;
            this.geRavenSession = geRavenSession;
        ...
        public async Task Start()
        {
            ...
            subscription = dispatcher.Subscribe(lastCheckpoint, async (transactions, subscription) =>
            {
